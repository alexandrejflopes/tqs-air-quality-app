...
public class ReportServiceUnitTest {
    ...
    public Report setUpAveiroReport(){
        ...
        int thisHour = aveiroReport.getRequestTimeStamp().getHour();
        String hourValue = thisHour < 10 ? "0"+thisHour : String.valueOf(thisHour);
        int thisDay = aveiroReport.getRequestTimeStamp().getDayOfMonth();
        String dayValue = thisDay < 10 ? "0"+thisDay : String.valueOf(thisDay);
